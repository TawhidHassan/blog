...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form method="POST" enctype="multipart/form-data" action="{{route('author.profile.update')}}">
                                @csrf
                                @method('PUT')
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="settings_with_icon_title">
                                    <b>Password</b>
                                     <form method="POST" enctype="multipart/form-data" action="{{route('author.password.update')}}">
                                @csrf
                                @method('PUT')
