...
<div class="container-fluid">
            <div class="block-header">
                <h2>
                    JQUERY DATATABLES
                    <small>Taken from <a href="{{route('author.post.create')}}" target="_blank" style="color: red;font-size: 20px;font-weight: bolder;border:2px solid red;padding:2px;">CREATE POST</a></small>
                </h2>
            </div>
            <!-- Exportable Table -->
                                        ...
                                        <tr>
                                             ...
                                             <td>@if($post->statas==true)
                                               ...
                                               <td class="text-center">
                                                <a href="{{route('author.post.show',$post->id)}}" class="btn btn-success waves-effect"><i class="material-icons">remove_red_eye</i></a>
