            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                <div class="info-box bg-pink hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="number count-to" data-from="0" data-to="{{ $catrgoty_count }}" data-speed="15" data-fresh-interval="20"></div>
                    </div>
                </div>
                ...
                <div class="info-box bg-deep-purple hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="number count-to" data-from="0" data-to="{{ $new_user_add }}" data-speed="15" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-hover dashboard-task-infos">
                                ...
                                <tbody>
                                    @foreach($active_user as $key=>$author)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $author->name }}</td>
